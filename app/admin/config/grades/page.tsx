...
export default function GradesConfig() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-center p-10">
      {/* Header */}
      <h1 className="text-3xl font-light text-blue-700 mb-8 tracking-wide">Configure Grades</h1>

      {/* Form Card */}
      <div className="bg-white shadow-lg rounded-xl p-8 w-full max-w-md">
        <h2 className="text-lg font-light text-gray-600 mb-6 tracking-wide">Add a New Grade</h2>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div>
            ...
            />
            {errors.grade && (
              <p className="text-red-500 text-sm mt-2">{(errors.grade as FieldError).message}</p>
            )}
          </div>
      ...
      <div className="mt-10 bg-white shadow-lg rounded-xl p-8 w-full max-w-md">
        <h2 className="text-lg font-light text-gray-600 mb-6 tracking-wide">Current Grades</h2>
